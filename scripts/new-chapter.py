...
highest_chapter = max([int(chapter.replace('chapter', '').replace('.tex', ''))
...
os.system('cp -R chapter.tex ../chapters/chapter' +
          new_chapter_string + '.tex')

# add the chapter to the thesis
os.system('sed -i -e \'s/' + high_chapter_string + '}/' +

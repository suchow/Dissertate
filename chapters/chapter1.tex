\begin{savequote}[75mm] Nulla facilisi. In vel sem. Morbi id urna in diam
	...
	varius leo.  \qauthor{Quoteauthor Lastname} \end{savequote}

\chapter{The title of chapter one}

\newthought{There's something to be said} for having a good opening line. Morbi
...
\begin{figure} \includegraphics[width=\textwidth]{figures/fig1} \caption[Short
...
%%
\begin{FPfigure} \includegraphics[width=\textwidth]{figures/fullpage}
